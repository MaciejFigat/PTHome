...
var protect = (0, express_async_handler_1["default"])(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                //@ts-ignore
                _a = req;
                return [4 /*yield*/, userModel_1["default"].findById(decoded.id).select('-password')];
            case 2:
                //@ts-ignore
                _a.user = _b.sent();
                next();
